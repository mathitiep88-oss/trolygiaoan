...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Tiếp - Trường Tiểu học Minh Quang - ĐT: 096 2189 679</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Thị Tiếp - Trường Tiểu học Minh Quang - ĐT: 096 2189 679</div>", unsafe_allow_html=True)
